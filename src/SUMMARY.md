...
- [NLP](./nlp/index.md)
  - [Bert](./nlp/bert.md)
- [nncase](./nncase/index.md)
  - [comile流程](./nncase/compile_flow.md)
  - [k210 standalone sdk](./nncase/k210.md)
  - [face detect example](./nncase/face_detect_example.md)
- [Ray](./ray/index.md)
  - [Ray Paper](./ray/paper.md)
  - [Ray Remote](./ray/remote.md)
...
- [ClickHouse(daft)](./clickhouse/index.md)
...
- [TiDB](./tidb/index.md)
  ...
  - [数据类型](./tidb/types.md)
  - [expression](./tidb/expression.md)
  - [Online DDL](./tidb/ddl.md)
      - [Schema 存储](./tidb/ddl-schema-in-tikv.md)
      - [Schema Cache和加载](./tidb/ddl-schema-load.md)
      - [Schema Modification](./tidb/ddl-schema-modification.md)
      - [Online Schema Change](./tidb/ddl-online-schema-change.md)
  - [统计信息](./tidb/stat.md)
      - [基本概念](./tidb/basic-concepts.md)
      - [stats tables](./tidb/stat-tables.md)
      - [Analyze](./tidb/stat-analyze.md)
      - [Query Feedback](./tidb/stat-feedback.md)
      - [统计信息使用场景](./tidb/use-stat.md)
  - [Logical Optimize](./tidb/logical-optimize.md)
  - [Physical Optimize](./tidb/physical-optimize.md)
  - [DataSource](./tidb/datasource.md)
      - [buildDataSource](./tidb/datasource-build.md)
      - [索引范围计算](./tidb/range.md)
      - [table/index存储编码](./tidb/tablecodec.md)
      - [paritionProcessor](./tidb/datasource-paritionProcessor.md)
      - [PredicatePushDown](./tidb/datasource-predict-push-down.md)
      - [Physical Optimize](./tidb/datasource-physical-optimize.md)
  ...
  - [Join](./tidb/join.md)
      - [Join算法](./tidb/join-alg.md)
      - [Logical Optimize](./tidb/join-logical-optimize.md)
      - [Physical Optimize](./tidb/join-physical-optimize.md)
      - [Executor: Hash Join](./tidb/hash-join.md)
      - [Executor: Merge Join](./tidb/merge-join.md)
      - [Executor: Index Lookup Join](./tidb/index-lookup-join.md)
  - [Agg](./tidb/agg.md)
...
---
- [TiKV](./tikv/index.md)
  - [raft-rs](./tikv/raft2.md)
    - [RawNode](./tikv/raft_rawnode.md)
    - [Storage](./tikv/raft_storage.md)
    - [ProgressTracker](./tikv/progress_tracker.md)
    - [Hearbeat](./tikv/raft_hearbeat.md)
    - [Election](./tikv/raft_election.md)
    - [LogEntry](./tikv/raft_log_entry.md)
    - [Snapshot](./tikv/raft_snapshot.md)
    - [ConfChange](./tikv/raft_conf_change.md)
    - [ReadIndex](./tikv/raft_read_index.md)
  - [RaftKV](./tikv/raft-kv.md)
    - [BatchSystem](./tikv/batch-system2.md)
    - [RaftMessage](./tikv/raft_message.md)
    - [Raft Client](./tikv/raft_client.md)
    - [Region](./tikv/region2.md)
    - [PeerStorage](./tikv/peer_storage2.md)
    - [Thread Local Engine](./tikv/thread_local_engine.md)
    - [Leader Lease](./tikv/leader_lease.md)
    - [Read Index](./tikv/read_index.md)
    - [Async Snapshot](./tikv/async_snapshot2.md)
    - [Async Write](./tikv/async_write2.md)
    - [Region Epoch](./tikv/region_epoch.md)
    - [Conf Change](./tikv/conf_change2.md)
    - [Split Region](./tikv/split_region2.md)
    - [Merge Region](./tikv/merge_region2.md)
  - [Storage](./tikv/storage2.md)
    - [Percolator](./tikv/percolator.md)
    - [Percolator In TiKV](./tikv/percolator_in_tikv.md)
    - [2PC](./tikv/tikv_2pc.md)
    - [AsyncCommit](./tikv/async_commit.md)
    - [OnePC](./tikv/tikv_1pc.md)
    - [悲观事务](./tikv/pessimistic_lock.md)
    - [Resolve Lock](./tikv/txn_recovery.md)
    - [Scheduler](./tikv/scheduler2.md)
    - [Wait Lock](./tikv/wait_lock.md)
    - [死锁检测](./tikv/dead_lock.md)
    - [TiDB分组提交](./tikv/group_commit.md)
...
- [Trash]()
  ...
  - [Paper notes](./papers/index.md)
    ...
    - [draft: gfs](./papers/gfs.md)
    - [draft: Bw-tree(draft)](./papers/bw-tree.md)
